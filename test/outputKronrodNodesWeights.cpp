...
int test_values()
{
    ...
    for(size_t i=0;i<8;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod15(i);
    ...
    for(size_t i=0;i<4;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss15(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod21(i);
    ...
    for(size_t i=0;i<11;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod21(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss21(i);
    ...
    for(size_t i=0;i<5;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss21(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod31(i);
    ...
    for(size_t i=0;i<16;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod31(i);
    ...
    for(size_t i=0;i<8;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss31(i);
    ...
    for(size_t i=0;i<8;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss31(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod41(i);
    ...
    for(size_t i=0;i<21;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod41(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss41(i);
    ...
    for(size_t i=0;i<10;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss41(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod51(i);
    ...
    for(size_t i=0;i<26;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod51(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss51(i);
    ...
    for(size_t i=0;i<13;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss51(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod61(i);
    ...
    for(size_t i=0;i<31;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod61(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss61(i);
    ...
    for(size_t i=0;i<15;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss61(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod71(i);
    ...
    for(size_t i=0;i<36;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod71(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss71(i);
    ...
    for(size_t i=0;i<18;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss71(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod81(i);
    ...
    for(size_t i=0;i<41;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod81(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss81(i);
    ...
    for(size_t i=0;i<20;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss81(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod91(i);
    ...
    for(size_t i=0;i<46;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod91(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss91(i);
    ...
    for(size_t i=0;i<23;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss91(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod101(i);
    ...
    for(size_t i=0;i<51;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod101(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss101(i);
    ...
    for(size_t i=0;i<25;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss101(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod121(i);
    ...
    for(size_t i=0;i<61;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod121(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss121(i);
    ...
    for(size_t i=0;i<30;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss121(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGaussKronrod201(i);
    ...
    for(size_t i=0;i<101;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGaussKronrod201(i);
    ...
    {
        fout<<"\t"<<QuadratureKronrodValuesType::abscissaeGauss201(i);
    ...
    for(size_t i=0;i<50;++i)
    {
        fout<<"\t"<<QuadratureKronrodValuesType::weightsGauss201(i);
